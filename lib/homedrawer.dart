...
//                               boxShadow: <BoxShadow>[
//                                 BoxShadow(color: Colors.green.withOpacity(0.6), offset: const Offset(2.0, 4.0), blurRadius: 8),
//                               ],
//                             ),
//                             child: ClipRRect(
...
//                   'Sign Out',
//                   style: TextStyle(
//                     // fontFamily: Colors.red,.fontName,
//                     fontWeight: FontWeight.w600,
//                     fontSize: 16,
//                     color: Colors.red,
//                   ),
...
//                     width: 24,
//                     height: 24,
//                     child: Image.asset(listData.imageName, color: widget.screenIndex == listData.index ? Colors.blue : Colors.deepPurple),
//                   )
...
//                       fontSize: 16,
//                       color: widget.screenIndex == listData.index ? Colors.blue : Colors.limeAccent,
//                     ),
//                     textAlign: TextAlign.left,
//                   ),
//                 ],
